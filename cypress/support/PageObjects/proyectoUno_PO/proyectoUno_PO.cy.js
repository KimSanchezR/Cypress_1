class ProyectoUno_Po{
    ...
    visitHome(){
        let tiempo=1000  
        //Cypress.config("defaultCommandTimeout",15000)   //Tiempo de espera (Tiene hasta 15s para cargar el elemento) especifico para este metodo  
        before(()=>{    
    ...
    SeccionUno(name,last_name,email,t){
        ...
        cy.screenshot("Campo Nombre") //Para tomar capturas 
        cy.wait(tiempo)
