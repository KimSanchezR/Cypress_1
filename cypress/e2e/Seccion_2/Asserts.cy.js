...
describe("Asserts", () =>{
    ...
    it("Assert contain.text y have.text", () =>{ 
        ...
        cy.get("#userName").should("be.visible").type("Kimberly")
        cy.get("#userEmail").should("be.visible").type("Kimberly@gmail.com")
        cy.get("#submit").should("be.visible").click()

        cy.get("#name").should("have.text","Name:Kimberly")
        cy.get("#name").should("contain.text","Kimberly")
    ...
    it("Assert have.text más then", () =>{
        ...
        cy.get("#userName").should("have.value", "Kimberly").then(()=>{
            cy.get("#userEmail").should("be.visible").type("Kimberly@gmail.com")
            cy.get("#submit").should("be.visible").click()
        })
    ...
    it("Assert length y el css", () =>{
        ...
        cy.get("#myTable >tr >td").should("have.length", 91).and("have.css", "padding", "8px") //el tr y td va mostrando la cantdad de elementos dela tabla
